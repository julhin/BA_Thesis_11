...
\end{itemize}
\paragraph{R5: definition of access rights}
Since the previous requirements are  fulfilled with the defined system extensions, in this step the ACM is reviewed and updated. The updated ACM is shown in \autoref{ACM_updated}. The entries that have changed since the old version are shown in bold.
...
Even with the system extensions for the previous requirements, there is no need to review and update the different types of data processing.
\subsection{P5: Evaluation of the defined access rights}
\subsubsection{Are the access rights well defined ?}
