...
As mentioned before, the resulting case study can be used in data-based privacy analysis. The assurance for privacy is there evaluated by using information flows. As a fundamental work, we used the publication from McLean % ref
