...
%SEFF  specification
The excerpt is extended with \textit{operations}. For each component one or more operations are defined, which models the observable behavior for this component. First, we describe the observable behavior of the scenario across all components with the data processing for each component. Secondly, all operations are merged into a data flow.
...
\subsection{Data processing in the components}
In this scenario
