...
For the created case study in \autoref{ch:cocome} and \autoref{ch:casestudysystem}, the answer is yes and no.\\
...
Given the fact, that not all information flow classes are covered
\section{Discussion}
