...
The last step of the procedure is to decide whether the procedure can be concluded. If the procedure cannot be concluded the procedure moves back to the SThe decision is based on the covered information flow classes. After the evaluation in % ref
